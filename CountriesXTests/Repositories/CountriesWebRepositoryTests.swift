...
class CountriesWebRepositoryTests: XCTestCase {
    ...
    override func setUp() {
        ...
        sut = RealCountriesWebRepository(session: .mockedResponsesOnly, baseURL: "https://test.com")
    }
    ...
    func test_countryDetails() throws {
        ...
        let value = Country.Details.Intermediate(capital: "London", currencies: [Country.Currency(code: "12", symbol: "$", name: "US dollar")], borders: countries.map({ $0.alpha3Code }))
